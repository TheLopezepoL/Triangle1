...
/*
/ Se agregó soporte para FOR, REPEAT. 
For: se utiliza el método layoutQuaternary para organizar la estructura del nodo con cuatro elementos: 
el nombre de la instrucción ("ForCommand"), la variable de bucle, la expresión de inicio, la expresión de fin 
y el cuerpo del bucle. 
Repeat: se utiliza layoutBinary para organizar el nodo con dos elementos: 
el cuerpo del bucle y la condición de salida, con el nombre "RepeatU." lo que indica que es un ciclo repetitivo.
...
public Object visitForCommand(ForCommand ast, Object obj) {
  return layoutQuaternary("ForCommand", ast.V, ast.E1, ast.E2, ast.C);
}

  public Object visitRepeatCommand(RepeatCommand ast, Object obj) {
    return layoutBinary("RepeatU.", ast.C, ast.E);
}
